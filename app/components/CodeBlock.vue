...
<template>
  ...
  >
    <div class="from-primary/10 absolute inset-0 bg-gradient-to-tr via-transparent to-transparent opacity-50" />

    <div class="relative">
      <div class="border-foreground/10 bg-background/5 flex items-center justify-between border-b px-4 py-2 backdrop-blur-sm">
