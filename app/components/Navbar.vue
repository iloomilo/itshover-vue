  ...
  <nav
    ...
    <div class="mx-auto flex h-16 w-full items-center justify-between px-4 md:px-8">
      ...
      <div class="hidden flex-1 items-center justify-end gap-2 md:flex">
        ...
        <button @click="toggleCommandMenu"
          ...
          <input type="text" readonly placeholder="Search Components..." @click="toggleCommandMenu"
            @focus="toggleCommandMenu"
      ...
      <div class="flex items-center md:hidden">
        <ColorModeToggle />
        <button class="ml-2 p-2 text-neutral-600 focus:outline-none dark:text-gray-100" @click="toggleMobileMenu">
