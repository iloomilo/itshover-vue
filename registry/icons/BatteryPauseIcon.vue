...
<template>
  ...
  >
    ...
    >
      <path class="battery-pause-bar battery-pause-1" d="M10 31V17" />
      <path class="battery-pause-bar battery-pause-2" d="M17 31V17" />
      <path class="battery-pause-bar battery-pause-3" d="M24 31V17" />
      <path class="battery-pause-bar battery-pause-4" d="M31 31V17" />
