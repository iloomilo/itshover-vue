...
const start = () => {
  animate('.ts-text', { pathLength: [0, 1], opacity: [0, 1] }, { duration: 0.6, ease: 'easeOut' })
  animate('.border', { scale: [1, 1.03, 1] }, { duration: 0.4, ease: 'easeInOut' })
}
...
<template>
  ...
  >
    ...
    />
    <path class="ts-text" d="M9 12h4" />
    <path class="ts-text" d="M11 12v6" />
    <path
      class="border"
