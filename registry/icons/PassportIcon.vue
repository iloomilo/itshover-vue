...
<template>
  ...
  >
    ...
    ></path>
    <!-- globe -->
    <path class="globe" d="M11 14a4 4 0 0 1 0-8M11 14a4 4 0 0 0 0-8"></path>
    <path class="globe" d="M11 14s1.5-1.79 1.5-4S11 6 11 6M11 14s-1.5-1.79-1.5-4S11 6 11 6"></path>
  </svg>
</template>
