...
const start = () => {
  animate(scope.value, { rotate: -10 }, { duration: 0.3, ease: 'easeOut' })
}

const stop = () => {
  animate(scope.value, { rotate: 0 }, { duration: 0.2, ease: 'easeIn' })
}
