...
const start = () => {
  animate('.front-flap', { skewX: 20 }, { duration: 0.4, ease: [0.4, 0, 0.2, 1] })
  animate('.elements', { x: -1, scale: 0.9, skewX: 20 }, { duration: 0.3, ease: 'easeInOut' })
  animate('.back-flap', { x: 4 }, { duration: 0.3, ease: 'easeInOut' })
}

const stop = () => {
  animate('.front-flap', { skewX: 0 }, { duration: 0.3, ease: 'easeIn' })
  animate('.elements', { x: 0, scale: 1, skewX: 0 }, { duration: 0.3, ease: 'easeOut' })
...
<template>
  ...
  >
    ...
    ></path>
    <path class="elements" d="M18.75 8.25a4 4 0 0 1-4-4"></path>
    <path class="elements" d="m7 9.75-.75.75.75.75.75-.75z"></path>
    <path
      class="elements"
      d="M.75 14.75a4 4 0 0 1 4 4m-4-10.5a4 4 0 0 0 4-4m14 10.5a4 4 0 0 0-4 4"
    ></path>
    <path class="elements" d="m11.75 14.55-1.5-.3 1.2-1.2z"></path>
