...
const start = () => {
  animate('.hexagon', { rotate: [0, 360] }, { duration: 1, ease: 'easeInOut' })
  animate(
    '.dollar',
...
const stop = () => {
  animate('.dollar, .hexagon', { pathLength: 1, opacity: 1, rotate: 0 }, { duration: 0.2 })
}
...
<template>
  ...
  >
    ...
    />
    <path class="dollar" d="M17 9h-3.5a1.5 1.5 0 0 0 0 3h2a1.5 1.5 0 0 1 0 3h-3.5" />
  </svg>
</template>
